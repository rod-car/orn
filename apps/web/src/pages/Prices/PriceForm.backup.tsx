...
export function PriceForm(): ReactNode {
    ...
    return (
        <form action="#" onSubmit={handleSubmit} method="post">
            ...
            <table className="table table-striped mb-4 table-hover text-sm">
                <thead>
                    <tr>
                        <th>Article</th>
                        <th>Unité</th>
                ...
                <tbody>
                    ...
                    {articlePrice && articlePrice.map((element: ArticlePrice, index) => <tr key={index}>
                        ...
                        <td>
                            {index === 0 && <Button onClick={addElement} type="button" mode="primary" icon="plus-lg" />}
                            {index > 0 && <Button onClick={() => removeElement(index)} type="button" mode="danger" icon="dash" />}
                        </td>
                    </tr>
                    )}
                </tbody>
