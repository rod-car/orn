    ...
    return (
        <>
            <div className="d-flex justify-content-between align-items-center mb-5">
                <h1>Détails enquête phase: {survey && survey.phase}</h1>
                <div className="d-flex">
                    <Link to="/survey/list" className="btn btn-primary me-2">
                        <i className="fa fa-list me-2"></i>Liste des enquêtes
                    </Link>
                    <Link to={`/survey/${id}/import-result`} className="btn btn-warning">
                        ...
                        {survey &&
                            survey.students.map((student) => (
                                <tr key={student.id}>
                                    ...
                                    <td className="text-center text-nowrap">{student.pivot.imc}</td>
